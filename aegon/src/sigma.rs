...
mod tests {
    ...
    use aegon_crypto::pcs::PolynomialCommitmentScheme;
    ...
    fn fixture(
        ...
        let srs = <aegon_crypto::pcs::kzhk::srs::KZHKUniversalParams<Bn254> as StructuredReferenceString<Bn254>>::gen_srs_for_testing(
            &mut rng, k, true, num_vars,
        )
        .expect("srs gen");
        let (pp, vk) =
            <aegon_crypto::pcs::kzhk::srs::KZHKUniversalParams<Bn254> as StructuredReferenceString<Bn254>>::trim(&srs, num_vars).expect("trim");
