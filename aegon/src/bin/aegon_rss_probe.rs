...
use aegon::config::AegonConfig;
use aegon::server::Aegon;
use aegon::{optimal_kzh_k, EcVrfHash};
...
fn main() -> ExitCode {
    let args = Args::parse();
    aegon::instrument::set_rss_log(true);
    ...
    aegon::instrument::log_rss("post_setup");
    ...
    aegon::instrument::log_rss("post_climb");
