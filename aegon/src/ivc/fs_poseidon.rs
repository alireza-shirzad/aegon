...
//!
//! So on the [`AuditFs::Poseidon`](crate::config::AuditFs)
...
//! ([`merkle_leaf`](crate::sharded::merkle_leaf) and friends)
...
/// circuit. Mirrors [`BlindingEqProof`](crate::BlindingEqProof)
...
/// [`EpochCommitment`](crate::EpochCommitment) and of
