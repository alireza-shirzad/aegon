...
use crate::audit_fs::{AuditFs, AuditFsHooks};
use crate::error::AegonError;
use crate::sharded::ShardedEpochCommitment;
use crate::types::EpochCommitment;
...
type Commitment = <Pcs as aegon_crypto::pcs::PolynomialCommitmentScheme<Bn254>>::Commitment;
...
/// [`ShardedAegonConfigBuilder::audit_fs`](crate::ShardedAegonConfigBuilder))
/// **and** on every verifier context
/// ([`VerifierContext::with_audit_fs`](crate::VerifierContext)).
...
/// entry point in this crate — the shard and coordinator servers and
/// the client — routes through here instead.
...
use crate::chain_groups::GroupPlan;
use crate::sharded::ShardedVerifierContext;
