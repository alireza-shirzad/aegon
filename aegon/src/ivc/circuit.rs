...
/// [`ShardedEpochCommitment`](crate::ShardedEpochCommitment) —
...
mod tests {
    use super::*;
    use crate::ivc::bridge::ark_fr_to_circuit;
    use crate::ivc::fs_poseidon::{poseidon_state_digest, ro_constants};
    use crate::ivc::synthetic::{
