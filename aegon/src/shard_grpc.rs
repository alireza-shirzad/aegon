...
where
    ...
    P::ProverParam: aegon_crypto::pcs::PCSGlobalParam + Send + Sync,
    P::VerifierParam: aegon_crypto::pcs::PCSGlobalParam + Send + Sync,
    P::Commitment: Clone
        + Send
        + Sync
...
where
    ...
    P::ProverParam: aegon_crypto::pcs::PCSGlobalParam + Send + Sync + 'static,
    P::VerifierParam: aegon_crypto::pcs::PCSGlobalParam + Clone + Send + Sync + 'static,
    ...
    EpochCommitment<E, P>: CanonicalSerialize + Send + Sync + 'static,
{
    ...
    pub fn new_with_checkpoint(
        ...
        let db: Arc<dyn Db> = match db_source {
            ...
            DbSource::Rocks(path) => Arc::new(crate::db::RocksDb::open(&path)?),
        };
        Ok(Self {
            aegon: Arc::new(AsyncRwLock::new(aegon)),
            db: Some(db),
