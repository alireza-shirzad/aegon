    ...
    E: Pairing,
{
    ...
    fn gen_srs_for_testing<R: Rng>(
        ...
        let srs = if srs_path.exists() {
            ...
            // file and fail deserialization. `aegon` depends on `aegon_crypto`
    ...
    fn generate_masking_package(
        ...
        Ok(crate::pcs::kzhk::structs::KZHKMaskingPackage::new(
...
impl<E: Pairing> KZHK<E> {
    ...
    fn apply_masking_package(
        ...
        tau_f: &E::ScalarField,
        transcript: &mut IOPTranscript<E::ScalarField>,
        package: &crate::pcs::kzhk::structs::KZHKMaskingPackage<E>,
