...
// The SEEMless/Merkle append-only zero-knowledge set. Aegon replaced this
// backend behind `Directory`, so much of it is unreachable; it is retained
// rather than deleted to keep the divergence from facebook/akd reviewable.
#![allow(dead_code)]
